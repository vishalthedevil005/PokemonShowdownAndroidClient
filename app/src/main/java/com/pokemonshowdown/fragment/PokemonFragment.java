...
import com.pokemonshowdown.dialog.LevelDialog;
...
public class PokemonFragment extends DialogFragment {
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        if (getActivity() instanceof TeamBuilderActivity) {
            TeamBuilderActivity parent = (TeamBuilderActivity) getActivity();
           // parent.updateList();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        pokemonView.setImageResource(getPokemon().getFrontSprite());

        pokemonView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getPokemon().switchFrontShiny(getActivity());
                pokemonView.setImageResource(getPokemon().getFrontSprite());
            }
        });
        ...
        gender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getPokemon().isGenderAvailable()) {
                    ...
                    gender.setImageResource(getPokemon().getGenderIcon());
                    int pokemonSprite = getPokemon().getFrontSprite();
